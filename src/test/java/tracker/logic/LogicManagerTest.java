...
import static tracker.commons.core.Messages.MESSAGE_INVALID_BOOK_DISPLAYED_INDEX;
...
public class LogicManagerTest {
    ...
    public void execute_storageThrowsIoException_throwsCommandException() {
        ...
        String addCommand = AddCommand.COMMAND_WORD + NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY
                + ADDRESS_DESC_AMY + BUSINESS_SIZE_DESC_AMY + COMPANY_DESC_AMY + PRIORITY_DESC_AMY
                + TRANSACTION_COUNT_DESC_AMY;
        Book expectedPerson = new PersonBuilder(AMY).withTags().build();
        ModelManager expectedModel = new ModelManager();
        expectedModel.addBook(expectedPerson);

...
import static tracker.commons.core.Messages.MESSAGE_UNKNOWN_COMMAND;
...
import tracker.logic.commands.ClearCommand;
import tracker.logic.commands.DeleteCommand;
import tracker.logic.commands.EditCommand;
import tracker.logic.commands.EditCommand.EditBookDescriptor;
import tracker.logic.commands.ExitCommand;
import tracker.logic.commands.FilterCommand;
import tracker.logic.commands.FindCommand;
import tracker.logic.commands.HelpCommand;
import tracker.logic.commands.ListCommand;
import tracker.logic.commands.SummaryCommand;
...
import tracker.testutil.PersonUtil;

public class BookTrackerParserTest {

    private final BookTrackerParser parser = new BookTrackerParser();
    ...
    public void parseCommand_edit() throws Exception {
        Book person = new PersonBuilder().build();
        EditBookDescriptor descriptor = new EditBookDescriptorBuilder(person).build();
    ...
    public void parseCommand_find() throws Exception {
        ...
        assertEquals(new FindCommand(new BookContainsKeywordsPredicate(keywords)), command);
    }
    ...
    public void parseCommand_filter() throws Exception {
        ...
        // assertEquals(new FindCommand(new NameContainsKeywordsPredicate(keywords)), command);
        assertEquals(new FilterCommand(new BookContainsTagsPredicate(keywords)), command);
    }
